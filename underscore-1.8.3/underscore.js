...
(function () {
  ...
  // 本人验证
  // 在nodejs9.3.0中
  // typeof exports != 'undefined' && !exports.nodeType   => true
  // typeof module != 'undefined' && !module.nodeType && module.exports  => {}

  // 所以在nodejs中,exports._ = _
  // 或者 exports = node.exports = _
  // 游览器root._ = _
  ...
  // 可能的使用方式
  // shallowProperty(key)(obj)
  // shallowProperty 函数是用来获取对象对应键名的值的, 
  var shallowProperty = function (key) {
    return function (obj) {
      return obj == null ? void 0 : obj[key]; // 严谨性,如果没有传入obj,就返回void 0(既是不返回值)
    };
  };
  // ???没明白
